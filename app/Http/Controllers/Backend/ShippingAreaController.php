...
class ShippingAreaController extends Controller
{
    ...
    public function AllDistrict(){
        $district = ShipDistrics::latest()->get();
    ...
    public function StoreDistrict(Request $request){
        ...
        $notification = array(
            'message' => 'ShipDistrics Inserted Successfully',
            'alert-type' => 'success'
        );
    ...
    public function EditDistrict($id){
        $district = ShipDistrics::findOrFail($id);
        $division = ShipDivision::orderBy('division_name', 'ASC')->get();
    ...
    public function UpdateDistrict(Request $request){
        ...
        ShipDistrics::findOrFail($district_id)->update([
            'division_id' => $request->division_id,
            'district_name' => $request->district_name,
        ]);

        $notification = array(
            'message' => 'ShipDistrics Updated Successfully',
            'alert-type' => 'success'
        );
    ...
    public function DeleteDistrict($id){
        ShipDistrics::findOrFail($id)->delete();

        $notification = array(
            'message' => 'ShipDistrics Deleted Successfully',
            'alert-type' => 'success'
        );
    ...
    public function AddState(){
        $division = ShipDivision::orderBy('division_name', 'ASC')->get();
        $district = ShipDistrics::orderBy('district_name', 'ASC')->get();
        return view('backend.ship.state.state_add', compact('division', 'district'));
    } // End Method


    public function GetDistrict($division_id){
        $dist = ShipDistrics::where('division_id', $division_id)->orderBy('district_name', 'ASC')->get();

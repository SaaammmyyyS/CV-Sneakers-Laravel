           ...
           <div class="form-body mt-4">
            <div class="row">
               ...
               <div class="border border-3 p-4 rounded">
                ...
                <div class="mb-3">
                    <label for="inputProductTitle" class="form-label">Main Thumbmail</label>
                  ...
                  <div class="row g-3">
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" name="discount_price" class="form-control" id="discountPrice" placeholder="00.00">
                      </div>
                      <div class="col-md-6">
                        <label for="inputCostPerPrice" class="form-label">Product Code</label>
                        <input type="text" name="product_code" class="form-control" id="productCode" placeholder="00.00">
                      </div>
                      <div class="col-md-6">
                        <label for="inputStarPoints" class="form-label">Product Quantity</label>
                        <input type="text" name="product_qty" class="form-control" id="productQuantity" placeholder="00.00">
                      </div>
                      <div class="col-12">

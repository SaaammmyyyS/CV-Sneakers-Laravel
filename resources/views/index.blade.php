                                        ...
                                        <form method="POST" action="{{route('user.profile.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input class="form-control" name="phone" type="tel" value="{{$userData->phone}}" />
                                                </div>
                                                <div class="form-group col-md-12">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label>User Photo <span></span></label>
                                        ...
                                        <form method="POST" action="{{route('user.update.password')}}">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input class="form-control @error('old_password') is-invalid @enderror" id="current_password" placeholder="Old Password" name="old_password" type="password" />
                                                    @error('old_password')
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input class="form-control @error('new_password') is-invalid @enderror" id="new_password" placeholder="New Password" name="new_password" type="password" />
                                                    @error('new_password')
                                                    <span class="text-danger">{{$message}}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input class="form-control @error('old_password') is-invalid @enderror" id="new_password_confirmation" placeholder="Confirm New Password" name="new_password_confirmation" type="password" />
                                                </div>

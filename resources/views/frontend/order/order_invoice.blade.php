  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>CV Sneakers</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               CV Sneakers Head Office
               Email:cvsneakersdvo@gmail.com <br>
               Mob: 1245454545 <br>
               Plaza de Bole, F. Torres Street, Davao City, <br>

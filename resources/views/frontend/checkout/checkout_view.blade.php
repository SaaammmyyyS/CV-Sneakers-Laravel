...
<table class="table no-border">
    <tbody>
        ...
        <tr>
            <td class="image product-thumbnail"><img src="{{asset($item->options->image)}}" style="width: 50px; height: 50px;" alt="#"></td>
            <td>
...
<tbody>
    ...
    <tr>
        ...
        <td class="cart_total_amount">
            <h4 class="text-brand text-end">${{session::get('coupon')['coupon_discount']}}</h4>
        </td>
    </tr>

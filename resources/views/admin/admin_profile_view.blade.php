                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{ (!empty($adminData->photo) ? url('upload/admin_images/'.$adminData->photo):url('upload/admin_images/no_image.jpg')) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                        ...
                        <form method="POST" action="{{route('admin.profile.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ (!empty($adminData->photo) ? url('upload/admin_images/'.$adminData->photo):url('upload/admin_images/no_image.jpg')) }}" alt="Admin" style="width:100px; height:100px;">
                                    </div>
                                </div>
                                <div class="row">
